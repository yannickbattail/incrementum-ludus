var Scenario = (function () {
    ...
    Scenario.initEngine = function () {
        ...
        var triggerLevel7 = new Trigger("iron age")
            ...
            .thatCraft(10, IRON).thatCraft(1, FULL_TRASH)["in"](1).minutes()
            ...
            .thatCraft(1, EMPTY_TRASH)["in"](40).seconds()
            ...
            .thatCraft(1, KNIFE).thatCraft(2, FULL_TRASH)["in"](4).minutes()
            ...
            .thatCraft(1, AXE).thatCraft(3, FULL_TRASH)["in"](4).minutes()
