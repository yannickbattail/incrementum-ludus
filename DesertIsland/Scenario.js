...
var POTABLE_WATER = new CategorizedMaterial("potable water", "cl", "water_potable.svg", "global");
var WOOD = new CategorizedMaterial("wood", "g", "wood.svg", "global");
var VEGETABLE = new CategorizedMaterial("vegetable", "g", "vegetable.svg", "global");
var FOOD = new CategorizedMaterial("food", "g", "food.svg", "global");
var CHARCOAL = new CategorizedMaterial("charcoal", "g", "charcoal.svg", "global");
var IRON_ORE = new CategorizedMaterial("iron ore", "g", "iron_ore.svg", "global");
var IRON = new CategorizedMaterial("iron", "g", "iron.svg", "global");
var COPPER_ORE = new CategorizedMaterial("copper ore", "g", "copper_ore.svg", "global");
var CLAY_POT = new CategorizedItem("clay pot", "clay_pot.svg", "global");
var BRICK = new CategorizedItem("brick", "brick.svg", "global");
var TERRACOTTA_POT = new CategorizedItem("terracotta pot", "terracotta_pot.svg", "global");
var KNIFE = new CategorizedItem("knife", "knife.svg", "global");
var AXE = new CategorizedItem("axe", "axe.svg", "global");
var EMPTY_TRASH = new CategorizedItem("empty trash", "empty_trash.svg", "global");
var FULL_TRASH = new CategorizedItem("full trash", "full_trash.svg", "global");
var STARVATION_FOOD = new CategorizedItem("starvation", "skull_grey.svg", "global");
var STARVATION = new CategorizedItem("starvation", "skull_white.svg", "global");
