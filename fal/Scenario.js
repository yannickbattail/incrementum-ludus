...
var ADOPTION_INGE = new Item("adoption ingé", "adopt_inge.png");
var ADOPTION_SCIENCES = new Item("adoption sciences", "adopt_sciences.png");
var ADOPTION_DROIT = new Item("adoption droit", "adopt_droit.png");
var ADOPTION_JAUNE = new Item("adoption jaune", "adopt_jaune.png");
var ADOPTION_ROSE = new Item("adoption rose", "adopt_paramed.png");
var ADOPTION_SAGE_POUF = new Item("adoption sage-pouf", "adopt_sage-pouf.png");
var ADOPTION_PHARMA = new Item("adoption Pharma", "adopt_pharma.png");
var ADOPTION_MEDECINE = new Item("adoption Médecine", "adopt_medecine.png");
var PINS_INGE = new Item("pin's ingé", "etoile et foudre.png");
var PINS_SCIENCES = new Item("pin's sciences", "palmes croisees.png");
var PINS_DROIT = new Item("pin's droit", "balance romaine.png");
var PINS_JAUNE = new Item("pin's jaune", "livre ouvert et plume.png");
var PINS_ROSE = new Item("pin's rose", "ciseaux.png");
var PINS_SAGE_POUF = new Item("pin's sage-pouf", "croix ankh.png");
var PINS_PHARMA = new Item("pin's Pharma", "caducee pharmacie.png");
var PINS_MEDECINE = new Item("pin's Médecine", "caducee medecine.png");
var PINS_LYON = new Item("pin's LYON", "Lyon.svg");
var PINS_GRENOBLE = new Item("pin's Grenoble", "Grenoble.svg");
var PINS_VALENCE = new Item("pin's Valence", "Valence.svg");
var PINS_CLERMONT = new Item("pin's Clermont", "ClermontFerrand.svg");
var PINS_DIJON = new Item("pin's Dijon", "Dijon.svg");
var PINS_MONPEUL = new Item("pin's Monpeul", "Montpellier.svg");
var PINS_MARSEILLE = new Item("pin's Marseille", "Marseille.svg");
var PINS_NANCY = new Item("pin's Nancy", "Nancy.svg");
var PINS_STASBOURG = new Item("pin's Strasbourg", "Strasbourg.svg");
